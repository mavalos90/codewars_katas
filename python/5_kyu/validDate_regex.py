...
import re
valid_date = re.compile('\[(((0[13578]|1[02])\-(0[1-9]|[12][\d]|3[01]))|((0[469]|11)\-(0[1-9]|[12][\d]|30))|(02\-(0[1-9]|1[\d]|2[0-8])))\]')
...
'\[ 
    ...
    (((0[13578]|1[02]) 
        \- # Separate by -
        (0[1-9]|[12][\d]|3[01])) # Range of days from 01 to 31
    | # Separate first group
    # Months with 30 days
    ((0[469]|11)
        \- # Separate by 
        # Range of days from 01 to 30
        (0[1-9]|[12][\d]|30))
    |
    # Days of Februeary
    (02\-(0[1-9]|1[\d]|2[0-8]))
